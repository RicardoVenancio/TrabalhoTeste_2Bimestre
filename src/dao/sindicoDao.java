...
public class sindicoDao extends ConexaoHSQLDB{
	final static String SQL_INSERT_SINDICOO = "INSERT INTO SINDICOO(NOMESINDICO, DATANASCIMENTO, SEXOSINDICO, EMAILSINDICO, NUMEROTELEFONESINDICO, DATAADMISSAO) VALUES (?,?,?,?,?,?)";
	final String SQL_SELECT_SINDICOO = "SELECT * FROM SINDICOO";
	final static String SQL_SELECT_SINDICO_ID = "SELECT * FROM SINDICOO WHERE IDSINDICO = ?";
	final static String SQL_ALTERA_SINDICO = "UPDATE SINDICOO SET NOMESINDICO=?, DATANASCIMENTO=? , SEXOSINDICO=?, EMAILSINDICO=?, NUMEROTELEFONESINDICO=?, DATAADMISSAO=? WHERE IDSINDICO = ?";
	final static String SQL_DELETA_SINDICO = "DELETE FROM SINDICOO WHERE IDSINDICO = ?";

public static boolean inserir(Sindico sindicoo) {
...
public List<Sindico> listAll(){
	...
	//BUSCAR PELO ID
public static Sindico findByID(int idSindico) {
...
//	}
	...
	//ALTERAR SINDICO
public static boolean alterar(Sindico sindico) {
	...
	// DELETAR SINDICO
	public static int deletar(int idSindico) {
		int quantidade = 0;
